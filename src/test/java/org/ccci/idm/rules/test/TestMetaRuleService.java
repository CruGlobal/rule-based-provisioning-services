...
public class TestMetaRuleService
{
    ...
    public void firstTest() throws Exception
    {
        ...
        props.setProperty("stellent.base", "ccci:itroles:uscore:stellent");
        ...
        props.setProperty("siebel-resp.base", "ccci:itroles:uscore:siebel:resp");
        ...
        props.setProperty("siebel-access.base", "ccci:itroles:uscore:siebel:resp");
