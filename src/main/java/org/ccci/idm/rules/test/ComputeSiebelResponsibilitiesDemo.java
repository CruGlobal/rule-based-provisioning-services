...
public class ComputeSiebelResponsibilitiesDemo
{
    ...
    {
      RuleBasedRoleProvisioningService svc = new RuleBasedRoleProvisioningService(new RoleManagerServiceGrouper("siebel.responsibility.rules@ccci.org", "ccci:itroles:uscore:siebel:resp", true));
